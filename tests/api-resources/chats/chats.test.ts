...
describe('resource chats', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.chats.retrieve('chatId');
  ...
  test.skip('markAsRead', async () => {
    const responsePromise = client.chats.markAsRead('chatId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('shareContactCard', async () => {
    const responsePromise = client.chats.shareContactCard('chatId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
